          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-3">
              ...
              <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <Image
                    className="w-[20vw] rounded ml-2 sm:rounded-none sm:rounded-l-lg"
                    src={team3}
                    alt="Majid Khan"
                  />
                </a>
                <div className="p-5">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">UC Chairman</span>
              ...
              <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                  <h3 className="text-xl -bold tracking-tight text-gray-900 dark:text-white">
                    <a href="#">Ibrahim Siddiqui</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">UC Vice Chairman</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
