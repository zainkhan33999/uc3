...
const Header = () => {
  return (
    <div>
      <div className="w-full bg-[#101828] p-3 cursor-pointer text-md text-white text-secondry px-5 hidden md:block">
        ...
        <section>
            ...
            <div className="flex gap-5 flex-wrap">
              <div className="flex gap-2 items-center">
                <p>
                  <FaMapLocationDot   className="text-[#1b9c59]"/>{" "}
                </p>
                <p>Find A Location</p>
              </div>
              ...
              <div className="flex gap-2 items-center">
                <p>
                  <FaPhoneAlt className="text-[#1b9c59]" />
                </p>
                <p>+92 336 3332468</p>
              </div>
              <div className="flex gap-2 items-center">
                <p>
                  <MdEmail  className="text-[#1b9c59]"/>{" "}
                </p>
